function evalp = paralleltxparams_brain_multiband_axial
...
evalp.evalmapsfname = 'brain_maps_multiband_axial.mat'; % name of the .mat file containing the processed maps
...
evalp.maxInSliceErr = 15; % max in-slice flip angle error (degrees)
evalp.maxInSliceRMSE = 3; % max in-slice flip angle RMS error (degrees)

% slice position-specific target pattern specs
evalp.slCent = 14/5*((0:4)-2);%[-4 0 4]; % slice positions in z (cm)
